...
const itemsTableBody = document.getElementById('itemsTableBody');
    ...
    // Función para crear una pelicula
    ...
    function loadItems() {
        ...
        .catch(error => capturarErrores(error));
    }
    ...
    // Función para actualizar una pelicula
    ...
    // Función para capturar errores y mostrar la alerta en el navegador
    function capturarErrores(error) {
        console.error('Error:', error);
        alert(error);
    }
